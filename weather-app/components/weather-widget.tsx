...
export default function WeatherWidget() {
    ...
    const[weather,setWeather]=useState<WeathertData|null>(null)
    ...
    const handleSearch = async(e:FormEvent<HTMLFormElement>) => {
        ...
        if(trimmedLocation === ""){
            setError("Pls enter a valid Location")
            setWeather(null)
            return;
        }
        setIsLoading(true);
        ...
        try{
            ...
            const weatherData :WeathertData = {
    ...
    function getTemperatureMessage(temperature: number, unit: string): string {
      ...
      function getLocationMessage(location:string):string{
        ...
        return `${location} ${isNight?"at night":"During the morning"}`
      }
